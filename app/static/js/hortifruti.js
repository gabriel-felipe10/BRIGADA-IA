...
window.BrigadaHortifruti = {
    ...
    return `
      ...
      <div class="toolbar">
        <div class="search-box">
          ...
          <input type="text" id="search-products-hortifruti" class="search-input" placeholder="Buscar por nome ou PLU...">
        </div>
  ...
  exportPDF() {
    ...
    let htmlContent = `
      <html>
      <head>
        <title>Relatório de Validades — Setor de Hortifruti</title>
        <style>
