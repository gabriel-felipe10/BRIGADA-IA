    ...
    const rows = users.map(u => {
      ...
      return `
        <tr>
          ...
          <td data-label="Setor"><span class="badge" style="background:rgba(99,102,241,0.1); color:#818cf8; border:1px solid rgba(99,102,241,0.2);">${u.sector === 'todos' ? '🌍 Todos' : u.sector === 'açougue' ? '🥩 Açougue' : u.sector === 'pereciveis' ? '🍎 Perecíveis' : u.sector}</span></td>
