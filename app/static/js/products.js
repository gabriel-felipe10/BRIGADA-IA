...
window.BrigadaProducts = {
    ...
    return `
      <div class="panel-header">
        ...
        <div class="glass-actions-card" style="display:flex; gap:var(--sp-sm); flex-wrap:wrap; align-items:center;">
          ...
          <button class="btn btn--primary" id="btn-share-products" title="Compartilhar Relatório de Validades via WhatsApp / Web Share" style="background: rgba(16, 185, 129, 0.2); border-color: rgba(16, 185, 129, 0.5); color: #34d399;">
  ...
  bindEvents(container) {
    ...
    container.querySelector('#btn-share-products')?.addEventListener('click', () => this.shareProducts());
  ...
  exportPDF() {
    ...
    if (window.jspdf && window.jspdf.jsPDF) {
      ...
      doc.text('BRIGADA-IA — Relatório de Produtos (Açougue)', 14, 13);
    ...
    this.lastPDFContent = printContent;
  ...
  shareProducts() {
    ...
    doc.setTextColor(255, 255, 255);
    doc.setFont('helvetica', 'bold');
    doc.text('BRIGADA-IA — Relatório de Validades (Açougue)', 14, 13);
    ...
    window.BrigadaUI.shareDocPDF(doc, `relatorio_acougue_${new Date().toISOString().split('T')[0]}.pdf`, 'Relatório de Validades - Açougue');
  }
};
