  ...
  buildHTML() {
    if (this.selectedFreezer === null) {
      ...
      if (this.filterScheduleDay !== 'all' && this.filterScheduleDay !== 'today') {
        selectedSched = this.SCHEDULE.find(s => s.dayKey === this.filterScheduleDay) || todaySched;
      }
        ...
        <div class="chambers-page animate-fade-in">
          <div class="chamber-action-bar" style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 2rem; flex-wrap: wrap; gap: 1rem;">
            ...
            <div class="chamber-active-info" style="display: flex; align-items: center; gap: 10px; flex-wrap: wrap;">
              ...
              <a href="/static/Folha_Auditoria_Freezer.pdf" target="_blank" title="Baixar folha A4 com espaço em branco para preenchimento manual" style="display: inline-flex; align-items: center; gap: 6px; font-size: 0.82rem; padding: 6px 12px; border-radius: 8px; text-decoration: none; color: #38bdf8; background: rgba(56, 189, 248, 0.15); border: 1px solid rgba(56, 189, 248, 0.4); font-weight: 700;">
                📋 Folha de Auditoria A4
              </a>
            </div>
          </div>
